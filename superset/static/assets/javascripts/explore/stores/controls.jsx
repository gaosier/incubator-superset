...
const TIME_PERIOD_START = moment().subtract(6, 'days').format('YYYY年MM月DD日');
const TIME_PERIOD_END = moment().format('YYYY年MM月DD日');
const TIME_PERIOD_DEFAULT = TIME_PERIOD_START + ' - ' + TIME_PERIOD_END;
...
export const controls = {
  ...
  time_period: {
    type: 'DatetimeRangePickerControl',
    freeForm: true,
    label: t('Time_period'),
    default: TIME_PERIOD_DEFAULT,
    description: 'TimePeriod from filter.',
  },
