...
class CalHeatmapViz(BaseViz):
    ...
    def get_data(self, df):
        ...
        diff_delta = rdelta.relativedelta(form_until, form_since)
        diff_secs = (form_until - form_since).total_seconds()
...
class BoxPlotViz(NVD3Viz):
    ...
    def get_data(self, df):
        ...
        if whisker_type == "Tukey":
            ...
            raise ValueError("未知的的whisker类型: {}".format(whisker_type))
